...
public class GuerraInfinita {
   ...
   JoiaAlma gemaAlma = new JoiaAlma("Gema Alma","Azul",5,"peder o dedo");
   JoiaRealidade gemaRealidade = new JoiaRealidade("Gema Realidade","Azul",5,"peder o dedo");
